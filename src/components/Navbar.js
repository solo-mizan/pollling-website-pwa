                ...
                <div className="navbar-start">
                    <div className="dropdown">
                        ...
                        <ul tabIndex={0} className="menu menu-compact dropdown-content mt-3 p-2 shadow bg-neutral text-neutral-content rounded-box w-52">
                            ...
                            <li><a href='https://mizanbd.netlify.app' target='_blank' rel='noreferrer'>Portfolio</a></li>
                        </ul>
                    </div>
                </div>
                <div className="navbar-center">
                    <Link to='/vote' className="btn btn-ghost normal-case text-xl">Vote for India!</Link>
                </div>
